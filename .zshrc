...
plugins=(drichard glide docker docker-compose vagrant autojump git python ssh-agent vundle brew osx history-substring-search zsh-syntax-highlighting golang postgres history-search-multi-word)
