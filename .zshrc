...
export ZSH="/Users/drichardson/.oh-my-zsh"
...
plugins=(drichard  zsh-autosuggestions zsh-completions docker docker-compose fasd git ssh-agent brew osx history-substring-search golang postgres history-search-multi-word zsh-syntax-highlighting fast-syntax-highlighting kubectl)
